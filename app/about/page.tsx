    ...
    <main className="min-h-screen w-full bg-[#E4E4E4] dark:bg-black text-gray-900 dark:text-gray-100 font-sans selection:bg-gray-900 selection:text-white pt-32 pb-20 px-6 sm:px-12">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="relative mb-20 border-b border-gray-900 dark:border-gray-800 pb-8 flex flex-col md:flex-row justify-between items-end gap-8">
          ...
          {/* DISTRIBUTED SYSTEM HEADER METADATA */}
          <div className="hidden md:block text-right">
             <div className="font-mono text-[10px] text-gray-400 uppercase tracking-widest space-y-1 opacity-70">
                <p>cluster: <span className="text-gray-900 dark:text-gray-200">main_net</span></p>
                <p>deploy: <span className="text-gray-900 dark:text-gray-200">production</span></p>
                <p>uptime: <span className="text-gray-900 dark:text-gray-200">99.9%</span></p>
             </div>
          </div>
        </div>
        ...
        >
          ...
          <motion.div
            ...
            className="py-12 border-b border-gray-300 dark:border-gray-800 grid grid-cols-1 lg:grid-cols-12 gap-8 items-start"
          >
            {/* LABEL COLUMN WITH TRACE LINE */}
            <div className="lg:col-span-4 relative pl-4 border-l border-dashed border-gray-400 dark:border-gray-700">
               {/* Node Indicator Dot */}
               <div className="absolute -left-[3px] top-14 w-1.5 h-1.5 bg-gray-900 dark:bg-white rounded-full"></div>
               
               <div className="sticky top-32">
                  <span className="text-sm font-mono uppercase tracking-widest text-gray-500 block mb-1">
                    [ 01_ORIGIN ]
                  </span>
                  {/* Creative Metadata: PID 001 is the first process launched in Linux */}
                  <span className="text-[9px] font-mono text-gray-400 uppercase tracking-tight block">
                    :: PID: 001 // init
                  </span>
               </div>
            </div>
            ...
            <div className="lg:col-span-8">
              <p className="text-xl sm:text-2xl font-medium leading-relaxed mb-6">
                ...
                software through{" "}
                <span className="underline decoration-1 underline-offset-4 decoration-gray-400">
                  Object-Oriented Design
                </span>
                .
              </p>
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed max-w-2xl">
                I fell in love with Computer Science immediately. The ability to
                model real-world phenomena and complex problems within a program
                fascinated me, and it set the foundation for my entire
                engineering philosophy. It also drew me toward environments
                where I could collaborate with driven teams, learn from
                encouraging mentors, and build solutions that deliver real
                value.
              </p>
            </div>
          </motion.div>
          ...
          >
            <div className="lg:col-span-4 relative pl-4 border-l border-dashed border-gray-400 dark:border-gray-700">
               ...
               <div className="sticky top-32">
                  ...
                  {/* Creative Metadata: Describes moving from single servers to distributed */}
                  <span className="text-[9px] font-mono text-gray-400 uppercase tracking-tight block">
            ...
            <div className="lg:col-span-8">
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed max-w-2xl mb-6">
                While I started with web development, I've developed a
                particular interest in Distributed Systems and Microservices.
                Currently, I'm expanding my appreciation for High Performance
                Computing (HPC) and AI/ML Systems.
              </p>
              <div className="flex flex-wrap gap-2">
                <span className="border border-gray-400 px-3 py-1 text-[10px] uppercase font-mono tracking-widest">
                  Distributed_Systems
                </span>
                <span className="border border-gray-400 px-3 py-1 text-[10px] uppercase font-mono tracking-widest">
                  Microservices
          ...
          >
            <div className="lg:col-span-4 relative pl-4 border-l border-dashed border-gray-400 dark:border-gray-700">
               ...
               <div className="sticky top-32">
                  ...
                  {/* Creative Metadata: Refers to reliability engineering */}
                  <span className="text-[9px] font-mono text-gray-400 uppercase tracking-tight block">
            ...
            <div className="lg:col-span-8">
              <p className="text-xl sm:text-2xl font-medium leading-relaxed mb-6">
                My favorite part of engineering is the deep exploration of
                problem domains—gaining knowledge through the rigorous process
                of solving them.
              </p>
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed max-w-2xl">
                I actively seek out complex system constraints to drive
                improvements. My focus is identifying opportunities for critical
                optimizations, ensuring architectural scalability, and making
                deliberate design decisions for fault tolerance.
              </p>
            </div>
          </motion.div>

          {/* PERSONAL LOG + CAT ANIMATION */}
          <motion.div
            variants={itemVariants}
            className="relative py-12 border-b border-gray-300 dark:border-gray-800 grid grid-cols-1 lg:grid-cols-12 gap-8 items-start overflow-hidden"
          >
            <div className="lg:col-span-4 relative pl-4 border-l border-dashed border-gray-400 dark:border-gray-700">
               <div className="absolute -left-[3px] top-14 w-1.5 h-1.5 bg-gray-900 dark:bg-white rounded-full"></div>
               ...
               <div className="sticky top-32">
                  ...
                  {/* Creative Metadata: CPU scheduling term for "User Mode" vs "Kernel Mode" */}
                  <span className="text-[9px] font-mono text-gray-400 uppercase tracking-tight block">
                    :: context_switch: user_space
                  </span>
               </div>
            </div>
            ...
            <div className="lg:col-span-8 relative z-10">
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed max-w-2xl">
                When I'm not developing, I'm a big entertainment nerd and enjoy
                watching TV shows and movies, hanging out with my siblings, or
                trying to manage our crazy cat.
              </p>
            </div>

            {/* THE CAT DAEMON - ALWAYS VISIBLE*/}
            <motion.div 
              className="absolute right-6 bottom-4 lg:right-20"
          ...
          >
            <div className="lg:col-span-4 relative pl-4 border-l border-dashed border-gray-400 dark:border-gray-700">
               ...
               <div className="sticky top-32">
                  ...
                  {/* Creative Metadata: AWS Region joke*/}
                  <span className="text-[9px] font-mono text-gray-400 uppercase tracking-tight block">
                    :: region: us-east-1
                  </span>
               </div>
            ...
            <div className="lg:col-span-8 grid grid-cols-2 sm:grid-cols-3 gap-8">
              <div>
                ...
                <p className="font-bold uppercase">Maryland, USA</p>
              </div>
              <div>
                <h4 className="text-[10px] font-mono text-gray-400 uppercase mb-2">
                  Status
                </h4>
                <p className="font-bold uppercase">Available 2026</p>
              </div>
              <div>
                <h4 className="text-[10px] font-mono text-gray-400 uppercase mb-2">
                  Focus
                </h4>
                <p className="font-bold uppercase">Full Stack / Systems</p>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="lg:col-span-8 flex flex-col sm:flex-row gap-4">
              <Link
                href="/contact"
                className="group relative px-8 py-4 bg-gray-900 dark:bg-white text-white dark:text-black font-mono text-xs uppercase tracking-widest flex items-center justify-center gap-3 overflow-hidden border border-transparent hover:border-black dark:hover:border-white transition-all w-full sm:w-auto"
              >
                <span className="relative z-10 flex items-center gap-2">
                  Initiate_Comm <SiGmail />
                </span>
              </Link>
              ...
              {/* <a
                ...
                download
                className="group px-8 py-4 bg-transparent border border-gray-900 dark:border-white text-gray-900 dark:text-white font-mono text-xs uppercase tracking-widest flex items-center justify-center gap-3 hover:bg-gray-900 hover:text-white dark:hover:bg-white dark:hover:text-black transition-all duration-300 w-full sm:w-auto"
              >
                <span>Download_Resume</span>
                <HiDownload className="group-hover:translate-y-0.5 transition-transform duration-300" />
              </a> */}
            </div>
          </motion.div>
        </motion.div>
